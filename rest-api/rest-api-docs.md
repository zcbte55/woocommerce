...
**Note: This documentation is for the v1 API which is now deprecated. Please use the `v2` endpoint and [read the v2 documentation](http://docs.woocommercev2.apiary.io/).**
