...
class WC_Tracker_Test extends \WC_Unit_Test_Case {
	 ...
	 */
	public function __disable_woocommerce_admin() {
		return true;
	}
	...
	public function test_wc_admin_disabled_get_tracking_data() {
		...
		add_filter( 'woocommerce_admin_disabled', array( $this, '__disable_woocommerce_admin' ) );
		...
		$this->assertEquals( 'yes', $tracking_data_disabled_wc_admin['wc_admin_disabled'] );
		remove_filter( 'woocommerce_admin_disabled', array( $this, '__disable_woocommerce_admin' ) );
	}
